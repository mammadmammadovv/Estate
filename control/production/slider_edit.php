...
$sliderquery->bindParam(":slider_id",$slider_id,PDO::PARAM_INT);
$sliderquery->execute();
          ...
          <div class="x_title">
            ...
            <div class="x_content">
              ...
              <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="slider_name" required="required" value="<?php echo $sliderpull['slider_name']?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="slider_estate_name" required="required" value="<?php echo $sliderpull['slider_estate_name']?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="slider_estate_price" required="required" value="<?php echo $sliderpull['slider_estate_price']?>" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
