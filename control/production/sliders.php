...
if (isset($_POST['search'])) {
  ...
  $sliderquery = $db->prepare("SELECT * FROM sliders WHERE slider_name LIKE :slider_name");
  $sliderquery->bindParam(":slider_name", $searchednamelike, PDO::PARAM_STR);
                  $sliderquery->execute();
              ...
              <table class="table table-striped jambo_table bulk_action">
                <thead>
                  <tr class="headings">
                    ...
                    <th class="column-title text-center">Slider adı </th>
                    <th class="column-title text-center">Slider Başlıq </th>
                ...
                <tbody>
                  ...
                  while ($sliderpull = $sliderquery->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr class="even pointer">
                      ...
                      <td class=" text-center "><?php echo $sliderpull['slider_name'] ?></td>
                      <td class=" text-center "><?php echo $sliderpull['slider_estate_name'] ?></td>
