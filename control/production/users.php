...
if (isset($_POST['search'])) {
  ...
  $adminquery = $db->prepare("SELECT * FROM admin_users WHERE admin_username LIKE :admin_username");
  $adminquery->bindParam(":admin_username",$searchednamelike,PDO::PARAM_STR);
                  $adminquery->execute();
                  ...
                  while ($adminpull = $adminquery->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr class="even pointer">
                      ...
                      <td class=" text-center"><a href="user_edit.php?admin_id=<?php echo $adminpull['admin_id'] ?>"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> Edit</button></a>
                        <a href="users.php?admin_users_delete=ok&admin_id=<?php echo $adminpull['admin_id'] ?>"><button class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</button></a>
                      </td>
                    </tr>
                  <?php }
                  ?>
